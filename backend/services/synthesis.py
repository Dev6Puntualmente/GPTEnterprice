...
def build_focused_synthesis_system(
    ...
    return (
        ...
        "Si DATOS CONSULTADOS tiene success:false, error o mensaje de fallo, "
        "di que no se pudo consultar el sistema y pide el dato que falte. "
        "NUNCA inventes listas, IDs, nombres ni valores que no estén en DATOS CONSULTADOS.\n"
        "Si pidió VARIAS cosas, responde en viñetas numeradas (1., 2., 3.) — una por cada parte.\n"
        "NUNCA muestres SQL ni digas que exportarás Excel si no hay URL en los datos.\n"
    ...
    "Si el usuario pidió borrar/eliminar/modificar y NO hay resultado de una tool de escritura, "
    "di claramente que esta integración es solo lectura y no se eliminó nada.\n\n"
